execute as @p if block ~ ~-4 ~ #powers:nonsolid if block ~ ~-5 ~ #powers:nonsolid if block ~ ~ ~ #powers:earth_bending/earth if block ~ ~-1 ~ #powers:earth_bending/earth if block ~ ~-2 ~ #powers:earth_bending/earth if block ~ ~-3 ~ #powers:earth_bending/earth run tag @s add G
...
#execute as @p if entity @s[tag=G] positioned ~ ~ ~ run execute as @e[tag=bsc_falling_A,tag=!done] run data modify entity @s Motion[1] set value -0.02d

execute as @p if entity @s[tag=G] positioned ~ ~ ~ run execute as @e[tag=bsc_falling_A,tag=!done] run scoreboard players set @s cal2 1
execute as @p if entity @s[tag=G] positioned ~ ~ ~ run execute as @e[tag=bsc_falling_A,tag=!done] run tag @s add pu
execute as @p if entity @s[tag=G] positioned ~ ~ ~ run execute as @e[tag=bsc_falling_A,tag=!done] run tag @s add no
