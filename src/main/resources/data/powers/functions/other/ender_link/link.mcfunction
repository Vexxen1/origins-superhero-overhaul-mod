...
execute if data entity @s SelectedItem.tag.ender_link run item modify entity @s weapon.mainhand powers:ender_link/unlink
execute if data entity @s Inventory[{Slot: -106b}].tag.ender_link run item modify entity @s weapon.offhand powers:ender_link/unlink
...
execute if entity @s[tag=link] if data entity @s SelectedItem.tag.ender_link run item modify entity @s weapon.mainhand powers:ender_link/link
execute if entity @s[tag=link] if data entity @s Inventory[{Slot: -106b}].tag.ender_link run item modify entity @s weapon.offhand powers:ender_link/link
