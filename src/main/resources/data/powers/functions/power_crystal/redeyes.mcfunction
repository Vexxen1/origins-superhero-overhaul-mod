...
execute if score @s pc.t matches 600.. if score @s powerstored matches 1.. run scoreboard players remove @s powerstored 1
execute if score @s pc.t matches 600.. if score @s powerstored matches 1.. run scoreboard players set @s pc.t 0
execute if score @s powerstored matches 0 run scoreboard players set @s pc.t 0

execute if score @s powerstored matches 1.. run particle minecraft:dust 1 0 0 1 ~ ~1.2 ~ 0.25 0.25 0.25 0.25 1
